/* Nepali Patro Homepage V9 — premium bright dashboard */
(function(){'use strict';
...
function loadV6(){if(document.getElementById('np-homepage-v6'))return;const link=document.createElement('link');link.id='np-homepage-v6';link.rel='stylesheet';link.href='css/homepage-v6.css?v=20260914-01';document.head.appendChild(link)}
function loadV7(){if(document.getElementById('np-homepage-v7'))return;const link=document.createElement('link');link.id='np-homepage-v7';link.rel='stylesheet';link.href='css/homepage-v7.css?v=20260914-01';document.head.appendChild(link)}
function loadV8(){if(document.getElementById('np-homepage-v8'))return;const link=document.createElement('link');link.id='np-homepage-v8';link.rel='stylesheet';link.href='css/homepage-v8.css?v=20260914-01';document.head.appendChild(link)}
function loadV9(){if(document.getElementById('np-homepage-v9'))return;const link=document.createElement('link');link.id='np-homepage-v9';link.rel='stylesheet';link.href='css/homepage-v9.css?v=20260914-01';link.onload=()=>document.body.classList.add('np-v9-ready');document.head.appendChild(link)}
...
function ready(){
 ...
 body.classList.add('np-v4-ready','np-v4-dashboard');addPhase2Style();loadV6();loadV7();loadV8();loadV9();forceBrightDefault();
