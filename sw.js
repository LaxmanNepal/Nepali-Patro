const CACHE_NAME='nepali-patro-v2026-09-03-02';
const OFFLINE_URL='./offline.html';
const APP_SHELL=['./','./index.html','./manifest.json','./assets/logo.svg','./offline.html','./css/main.css','./css/homepage-redesign.css','./css/mobile-nav.css','./js/mobile-nav.js','./js/homepage-runtime.js','./js/nepal-clock.js'];
...
async function cacheFirst(req){const key=cacheRequest(req);const cached=await caches.match(key);if(cached)return cached;try{return await put(key,await fetch(req));}catch{return new Response('',{status:504,statusText:'Offline'});}}
