const CACHE_NAME='nepali-patro-v2026-08-31-01';
...
self.addEventListener('fetch',e=>{const r=e.request;if(r.method!=='GET')return;const u=new URL(r.url);if(!sameOrigin(u))return;
  // Never intercept document navigation. This prevents stale/broken service-worker state from causing ERR_FAILED on page loads.
