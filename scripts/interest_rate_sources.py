...
The registry mirrors the canonical bank source URLs in banks.json. The parser
name is intentionally explicit so source-specific extraction can be added
without changing the publication schema.
"""
